        ...
        */
        ...
        function search() {
            if (document.getElementById("search_input").value != "") {
                window.location.href = "https://www.baidu.com/s?&wd=" + encodeURIComponent(document.getElementById("search_input").value) + "&uc_param_str=dnntnwvepffrgibijbprsvdsme&from=ucframe&uc_sm=1";
